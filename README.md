...
### Vizualizing results
The directory includes all files required for obtaining figures (both main and supplementary) presented in the article except for recombination and strain graphs wich were generated by Python scripts. The subdirectories follow the same structure as the aforementioned data for processing.
